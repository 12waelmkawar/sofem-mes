...
import BLPage from './pages/admin/BLPage';
...
import QualitePage from './pages/admin/QualitePage';
import DAPage from './pages/admin/DAPage';
import BCPage from './pages/admin/BCPage';
import BRPage from './pages/admin/BRPage';
import FAPage from './pages/admin/FAPage';
...
import OpTypesPage from './pages/admin/OpTypesPage';
...
function AdminPageRouter() {
  ...
  if (page === 'qualite') return <QualitePage />;
  if (page === 'nc') return <QualitePage />;
  if (page === 'da') return <DAPage />;
  if (page === 'bc') return <BCPage />;
  if (page === 'br') return <BRPage />;
  if (page === 'fa') return <FAPage />;
  if (page === 'maintenance') return <MaintenancePage />;
  if (page === 'reports') return <ReportsPage />;
  if (page === 'activity') return <ActivityPage />;
  if (page === 'planning') return <PlanningPage />;
  if (page === 'fournisseurs') return <FournisseursPage />;
  if (page === 'op-types') return <OpTypesPage />;
  if (page === 'analytics-production') return <AnalyticsPage />;
  if (page === 'analytics-achats') return <AnalyticsPage />;
  if (page === 'analytics-operateurs') return <AnalyticsPage />;
  if (page === 'analytics-qualite') return <AnalyticsPage />;
  if (page === 'settings') return <SettingsPage />;
  if (page === 'users') return <SettingsPage />;
